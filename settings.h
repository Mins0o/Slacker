...
#define WEATHER_UPDATE_INTERVAL \
  99             // must be greater than 5, measured in minutes
...
watchySettings settings{
    CITY_ID,       OPENWEATHERMAP_APIKEY,   OPENWEATHERMAP_URL, TEMP_UNIT,
    TEMP_LANG,     WEATHER_UPDATE_INTERVAL, NTP_SERVER,         GMT_OFFSET_SEC,
    DST_OFFSET_SEC};
